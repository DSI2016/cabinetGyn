 ...
 */
public class Cfclient_view implements java.io.Serializable {
	...
	public String toString() {
		return "Cfclient_view [code=" + code + ", prefix=" + prefix
				+ ", glycemie=" + glycemie + ", aghbs=" + aghbs
				+ ", categorie=" + categorie + ", prenomnom=" + prenomnom
				+ ", nomprenom=" + nomprenom + ", categoriEtoile="
				+ categoriEtoile + ", nom=" + nom + ", prenom=" + prenom
				+ ", ddgCorigee=" + ddgCorigee + ", cnss=" + cnss + ", sexe="
				+ sexe + ", civil=" + civil + ", dateNaiss=" + dateNaiss
				+ ", rue=" + rue + ", village=" + village + ", pays=" + pays
				...
				+ ", remarque=" + remarque + ", tPrevu=" + tPrevu
				+ ", tActuel=" + tActuel + ", toxo=" + toxo + ", tpha=" + tpha
				+ ", rubeole=" + rubeole + ", nbrGarcon=" + nbrGarcon
				+ ", nbrFille=" + nbrFille + ", cycleType=" + cycleType
				+ ", regleType=" + regleType + ", cycle=" + cycle
				+ ", prenomNomConjoint=" + prenomNomConjoint + ", professionP="
				+ professionP + ", professionC=" + professionC + ", archive="
				+ archive + "]";
	}
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((prenomNomConjoint == null) ? 0 : prenomNomConjoint
						.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cfclient_view other = (Cfclient_view) obj;
		if (aghbs == null) {
			if (other.aghbs != null)
				return false;
