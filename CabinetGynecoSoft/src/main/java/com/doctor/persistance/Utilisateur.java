...
public class Utilisateur implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((date_naiss == null) ? 0 : date_naiss.hashCode());
		result = prime * result
		...
		result = prime * result + (tabTelSal ? 1231 : 1237);
	...
	public boolean equals(Object obj) {
		...
		if (consultPat != other.consultPat)
			return false;
		if (date_naiss == null) {
			if (other.date_naiss != null)
				return false;
		} else if (!date_naiss.equals(other.date_naiss))
			return false;
	...
	public String toString() {
		return "Utilisateur [idutilisateur=" + idutilisateur + ", login="
				+ login + ", motPasse=" + motPasse + ", nom=" + nom
				+ ", prenom=" + prenom + ", date_naiss=" + date_naiss
				+ ", adresse=" + adresse + ", tel=" + tel + ", email=" + email
				+ ", civil=" + civil + ", menuSal=" + menuSal
				+ ", menuGestPat=" + menuGestPat + ", menuParametre="
				+ menuParametre + ", menuRapport=" + menuRapport
				+ ", menuGestUtl=" + menuGestUtl + ", menuGestRdv="
				+ menuGestRdv + ", menuGestStat=" + menuGestStat
				+ ", ajoutPatient=" + ajoutPatient + ", verSal=" + verSal
				+ ", modPatient=" + modPatient + ", detPatient=" + detPatient
				+ ", chargPatient=" + chargPatient + ", supPatient="
				+ supPatient + ", tabInfGenAjoutPat=" + tabInfGenAjoutPat
				...
				+ ", gestEFG=" + gestEFG + ", actif=" + actif + ", passif="
				+ passif + ", nbrEnfentFiche=" + nbrEnfentFiche
