...
public class Lettre {
	...
	private Set<historiqueLettre> historiqueLettre = new HashSet<historiqueLettre>();

	public Set<historiqueLettre> getHistoriqueLettre() {
		return historiqueLettre;
	}

	public void setHistoriqueLettre(Set<historiqueLettre> historiqueLettre) {
		this.historiqueLettre = historiqueLettre;
	}

	public Lettre(String nomLettre) {
		super();
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((Datelettre == null) ? 0 : Datelettre.hashCode());
		result = prime * result + ((autre == null) ? 0 : autre.hashCode());
		result = prime * result
				+ ((clinique == null) ? 0 : clinique.hashCode());
		result = prime * result + ((code == null) ? 0 : code.hashCode());
		result = prime * result
				+ ((dateActe == null) ? 0 : dateActe.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (Datelettre == null) {
			if (other.Datelettre != null)
				return false;
		} else if (!Datelettre.equals(other.Datelettre))
			return false;
		if (autre == null) {
			if (other.autre != null)
				return false;
			...
			return false;
		if (clinique == null) {
			if (other.clinique != null)
				return false;
		} else if (!clinique.equals(other.clinique))
			return false;
		if (code == null) {
			if (other.code != null)
				return false;
			...
			return false;
		if (dateActe == null) {
			if (other.dateActe != null)
				return false;
		} else if (!dateActe.equals(other.dateActe))
			return false;
		if (ddr == null) {
			if (other.ddr != null)
				return false;
		...
		if (diagnostic == null) {
			...
			return false;
		if (frotti == null) {
			if (other.frotti != null)
				return false;
		} else if (!frotti.equals(other.frotti))
			return false;
		if (gs == null) {
			if (other.gs != null)
				return false;
		...
		if (idlettre == null) {
			...
			return false;
		if (nomLettre == null) {
			if (other.nomLettre != null)
				return false;
		} else if (!nomLettre.equals(other.nomLettre))
			return false;
		...
		if (rh == null) {
			...
			return false;
		if (rubeoole == null) {
			if (other.rubeoole != null)
				return false;
		} else if (!rubeoole.equals(other.rubeoole))
			return false;
		if (termeactuel == null) {
			...
			return false;
		if (termeprevue == null) {
			if (other.termeprevue != null)
				return false;
		} else if (!termeprevue.equals(other.termeprevue))
			return false;
		if (textLettre == null) {
			if (other.textLettre != null)
				return false;
		} else if (!textLettre.equals(other.textLettre))
			return false;
		if (toxo == null) {
			if (other.toxo != null)
				return false;
	...
	public String toString() {
		return "lettre [idlettre=" + idlettre + ", Datelettre=" + Datelettre
				+ ", code=" + code + ", dateActe=" + dateActe + ", clinique="
				+ clinique + ", description=" + description + ", ddr=" + ddr
				+ ", debutGross=" + debutGross + ", autre=" + autre
				+ ", termeprevue=" + termeprevue + ", termeactuel="
				+ termeactuel + ", rubeoole=" + rubeoole + ", frotti=" + frotti
				+ ", gs=" + gs + ", rh=" + rh + ", resultatfrotti="
				+ resultatfrotti + ", diagnostic=" + diagnostic + ", tpha="
				+ tpha + ", toxo=" + toxo + ", textLettre=" + textLettre
				+ ", v1=" + v1 + ", v3=" + v3 + ", v2=" + v2 + ", v4=" + v4
				+ ", v5=" + v5 + ", v6=" + v6 + ", v7=" + v7 + ", v8=" + v8
				+ ", v9=" + v9 + ", v10=" + v10 + ", v11=" + v11 + ", v12="
				+ v12 + ", v13=" + v13 + ", v14=" + v14 + ", v15=" + v15
				+ ", v16=" + v16 + ", v17=" + v17 + ", v18=" + v18 + ", v19="
				+ v19 + ", v20=" + v20 + ", v21=" + v21 + ", v22=" + v22
				+ ", v23=" + v23 + ", v24=" + v24 + ", v25=" + v25 + ", v26="
				+ v26 + ", v27=" + v27 + ", v28=" + v28 + ", v29=" + v29
				+ ", v30=" + v30 + ", nomLettre=" + nomLettre + "]";
	}
